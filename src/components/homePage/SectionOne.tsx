    ...
    <div className="flex items-center justify-between gap-24 pb-48">
      <div className="flex flex-col gap-6 max-w-[550px]">
        ...
        <div className="flex items-center justify-between mt-10">
          <button className="inline-flex w-[227px] h-[55px] items-center justify-center rounded-2xl font-normal leading-7 text-black hover:bg-slate-200 border border-black bg-transparent">
            Стати волонтером
          </button>
